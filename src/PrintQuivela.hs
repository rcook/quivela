...
instance Print Expr where
  prt i e = case e of
    ...
    EProj expr id -> prPrec i 18 (concatD [prt 18 expr, doc (showString "."), prt 0 id])
    ECall expr exprs -> prPrec i 17 (concatD [prt 18 expr, doc (showString "("), prt 0 exprs, doc (showString ")")])
    EIdx expr1 expr2 -> prPrec i 17 (concatD [prt 17 expr1, doc (showString "["), prt 0 expr2, doc (showString "]")])
