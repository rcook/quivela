...
instance Print Expr where
  prt i e = case e of
    EVar id -> prPrec i 30 (concatD [prt 0 id])
    EConst val -> prPrec i 30 (concatD [prt 0 val])
    ETuple exprs -> prPrec i 20 (concatD [doc (showString "<"), prt 0 exprs, doc (showString ">")])
    ETupleProj expr1 expr2 -> prPrec i 19 (concatD [prt 19 expr1, doc (showString "^"), prt 20 expr2])
    EProj expr1 expr2 -> prPrec i 18 (concatD [prt 19 expr1, doc (showString "."), prt 18 expr2])
    EIdx expr1 expr2 -> prPrec i 17 (concatD [prt 18 expr1, doc (showString "["), prt 0 expr2, doc (showString "]")])
    ECall expr exprs -> prPrec i 17 (concatD [prt 18 expr, doc (showString "("), prt 0 exprs, doc (showString ")")])
    ENot expr -> prPrec i 17 (concatD [doc (showString "!"), prt 17 expr])
    EMul expr1 expr2 -> prPrec i 15 (concatD [prt 16 expr1, doc (showString "*"), prt 15 expr2])
    EDiv expr1 expr2 -> prPrec i 15 (concatD [prt 16 expr1, doc (showString "/"), prt 15 expr2])
    EAdd expr1 expr2 -> prPrec i 14 (concatD [prt 15 expr1, doc (showString "+"), prt 14 expr2])
    ESub expr1 expr2 -> prPrec i 14 (concatD [prt 15 expr1, doc (showString "-"), prt 14 expr2])
    EPostIncr expr -> prPrec i 14 (concatD [prt 15 expr, doc (showString "++")])
    ELt expr1 expr2 -> prPrec i 13 (concatD [prt 13 expr1, doc (showString "<"), prt 14 expr2])
    EEq expr1 expr2 -> prPrec i 13 (concatD [prt 13 expr1, doc (showString "=="), prt 14 expr2])
    EAssign expr1 expr2 -> prPrec i 10 (concatD [prt 10 expr1, doc (showString "="), prt 11 expr2])
